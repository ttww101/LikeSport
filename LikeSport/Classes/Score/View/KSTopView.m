...
- (void)setFootballResult:(FootballBaseResult *)footballResult
{
    ...
    if (footballResult.full_h != -1 && footballResult.full_c != -1) {
        _full_bf.text = [NSString stringWithFormat:@"%li - %li",(long)footballResult.full_h,(long)footballResult.full_c];
    }
    if (footballResult.half_h != -1 && footballResult.half_c != -1) {
        _half_bf.text = [NSString stringWithFormat:@"(%li-%li)",(long)footballResult.half_h,(long)footballResult.half_c];
    }
    
    if (footballResult.extratime_h != -1 && footballResult.extratime_c != -1 && footballResult.penalty_h != -1 && footballResult.penalty_c != -1) {
        _half_bf.text = [NSString stringWithFormat:@"HT:(%li-%li) ET:(%li-%li) PK:(%li-%li)",(long)footballResult.half_h,(long)footballResult.half_c,(long)footballResult.extratime_h,(long)footballResult.extratime_c,(long)footballResult.penalty_h,(long)footballResult.penalty_c];
    } else if (footballResult.extratime_h != -1 && footballResult.extratime_c != -1) {
        _half_bf.text = [NSString stringWithFormat:@"HT:(%li-%li) ET:(%li-%li)",(long)footballResult.half_h,(long)footballResult.half_c,(long)footballResult.extratime_h,(long)footballResult.extratime_c];
    } else if (footballResult.penalty_h != -1 && footballResult.penalty_c != -1){
        _half_bf.text = [NSString stringWithFormat:@"HT:(%li-%li) PK:(%li-%li)",(long)footballResult.half_h,(long)footballResult.half_c,(long)footballResult.penalty_h,(long)footballResult.penalty_c];
    }
...
- (void)setBasketballResult:(BasketResult *)basketballResult
{
    ...
    if (basketballResult.total_h != -1 && basketballResult.total_c != -1) {
        _full_bf.text = [NSString stringWithFormat:@"%li - %li",(long)basketballResult.total_h,(long)basketballResult.total_c];
    }

    if ((_basketballResult.st3_h != -1) && (_basketballResult.st3_c != -1) && (_basketballResult.st4_h != -1) && (_basketballResult.st4_c != -1)) {
        _half_bf.text = [NSString stringWithFormat:@"(%li-%li)",_basketballResult.st1_h + _basketballResult.st2_h,_basketballResult.st1_c + _basketballResult.st2_c];
    } else {
...
+ (instancetype)topView {
    return [[[NSBundle mainBundle] loadNibNamed:@"KSTopView" owner:self options:nil] firstObject];
