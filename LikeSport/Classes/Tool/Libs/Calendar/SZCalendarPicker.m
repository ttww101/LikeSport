...
- (void)awakeFromNib
{
    ...
    if ([Language rangeOfString:@"zh-Hans"].location != NSNotFound) {
        ...
        _weekDayArray = @[@"Sun",@"Mon",@"Tues",@"Wed",@"Thur",@"Fri",@"Sat"];
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        [cell.dateLabel setTextColor:KSBlue];
        ...
        if (i < firstWeekday) {
            ...
            [cell.dateLabel setTextColor:[UIColor colorWithHexString:@"#6f6f6f"]]; // 深灰
            
            //this month
            if ([_today isEqualToDate:_date]) {
                if (day == [self day:_date]) {
                    [cell.dateLabel setTextColor:[UIColor colorWithHexString:@"#4898eb"]]; // 蓝色
                } else if (day > [self day:_date]) {
                    [cell.dateLabel setTextColor:[UIColor colorWithHexString:@"#6f6f6f"]]; // 深灰
//                    [cell.dateLabel setTextColor:[UIColor colorWithHexString:@"#cbcbcb"]]; // 灰色
                }
